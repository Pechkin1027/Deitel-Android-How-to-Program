package com.benjaminbrusilovsky.addressbook;
...
import com.benjaminbrusilovsky.addressbook.data.DatabaseDescription.Contact;
        ...
        switch (id) {
            case CONTACTS_LOADER:
                return new CursorLoader(getActivity(),
                        Contact.CONTENT_URI, null, null,
                        null, Contact.COLUMN_NAME + " COLLATE NOCASE ASC");
            default:
                return null;
        }
    }
